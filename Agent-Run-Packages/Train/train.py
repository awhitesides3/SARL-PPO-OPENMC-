...
import numpy as np
###############################   Configuration   ########################################
i = sarl.override_default(sarl.default) #grabs the arguments that were passed through the 'python' command in the train.sh job script and overrides the SARL.py default parameters
